...
local T4646165643831105538 = T4646165643831105538 or {}
T4646165643831105538.__index = T4646165643831105538
function T4646165643831105538.new(construct, ...)
    local self = setmetatable({}, T4646165643831105538)
    self.duration = 2.0
    self.count = 0
    if construct and T4646165643831105538.constructor then T4646165643831105538.constructor(self, ...) end
    return self
end

function T4646165643831105538:constructor()

end

function T4646165643831105538:onStart(comp) 
...
function T4646165643831105538:animate()
	return {
		-- ['playSpeed'] = 30,
		['anchor'] = {0, 0},
		['pivot'] = {0, 0},
...
function T4646165643831105538:animateChar(char)
	...
	return {
		...
		['animations'] = {
			...
			['translate.y'] = {
				{0.0, 0.3, -char.height * 0.3, char.height * 0.4, {0.33, 1, 0.68, 1}},
				{0.3, 1, char.height * 0.4, 0, {.37,0,.48,1.36}}
			},
			['translate.z'] = {
			},
			['rotate'] = {
...
-- local time = 0
-- function T4646165643831105538:onUpdate(comp, deltaTime)
-- 	time = time + deltaTime
...
function T4646165643831105538:seek(time)
	if self.first then
		self.first = false
	end
...
function T4646165643831105538:setDuration(duration)
   self.duration = duration
end

function T4646165643831105538:clear()
	if self.text ~= nil then
		local chars = self.text.chars 
...
exports.T4646165643831105538 = T4646165643831105538
return exports
