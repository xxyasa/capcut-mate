...
function BounceIn:animate()
	return {
		...
		['animations'] = {
			...
			['scale'] = {
				{0, 1, {1, 1, 1}, {1,1,1}, {1.00, -0.01, 0.14, 0.99}}
			},
			['scale.x'] = {
			},
			['scale.y'] = {
...
function BounceIn:animateChar(char)
	return {
		...
		['animations'] = {
			...
			['scale.x'] = {
				{0, 0.29, 0, 1.03, {0.18, 0.00, 0.73, 1.00}},
				{0.29, 0.47, 1.03, 0.7, {0.42, 0.00, 0.67, 1.00}},
				{0.47, 0.58, 0.7, 1.02, {0.33, 0.00, 0.67, 1.00}},
				{0.58, 0.707, 1.02, .9, {0.17, 0.08, 0.83, 0.92}},
				{0.707, 0.817, .9, 1.01, {0.17, 0.08, 0.83, 0.92}},
				{0.817, 0.937, 1.01, .95, {0.17, 0.08, 0.83, 0.92}},
				{0.937, 1.0, .95, 1.00, {0.17, 0.08, 0.83, 0.92}}
			},
			['scale.y'] = {
			},
			['scale.z'] = {
...
function BounceIn:seek(time)
	if self.first then
		if self.text ~= nil then
			...
			self.materials:get(0):setInt('ANIMSEQ', 0)
		else
			self.materials:get(0):setInt('ANIMSEQ', 1)
		end
		self.first = false
	end
	...
	playAnimation(info, time / self.duration, function (key, value)
		...
		elseif key == 'blurType' then
            self.materials:get(0):setInt('u_BLUR_TYPE', value)
